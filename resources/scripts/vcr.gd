...
@onready var HourLabel: Label = %VCRHour
@onready var MinuteLabel: Label = %VCRMinute
@onready var SeperatorLabel: Label = %VCRSeperator
@onready var AMMeridian: Label = %VCRAm
@onready var PMMeridian: Label = %VCRPm
